...
import com.project.onlinebooking.exception.InvalidSearchDateException;
import com.project.onlinebooking.model.Stay;
import com.project.onlinebooking.service.SearchService;
...
public class SearchController {
    ...
    public List<Stay> searchStays(
            ...
            @RequestParam(name = "distance", required=false) String
                    distance) {
        LocalDate checkinDate = LocalDate.parse(start,
                DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        LocalDate checkoutDate = LocalDate.parse(end,
                DateTimeFormatter.ofPattern("yyyy-MM-dd"));
        ...
        return searchService.search(guestNumber, checkinDate,
                checkoutDate, lat, lon, distance);
    }
}
