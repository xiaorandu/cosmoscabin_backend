...
@Entity
@Table(name = "stay")  //name in the database
...
public class Stay implements Serializable {
    ...
    @OneToMany(mappedBy = "stay", cascade = CascadeType.ALL, fetch=FetchType.EAGER) //stay to images,
    // fetch eager: when get stay, join stay_image table at the same time
    // select * from stays where stay_id = 1
    // GetStayById() -> read stay from stay table, and read stayImage from stay_image table
    ...
    public static class Builder {
        ...
        public Builder setReservedDates(List<StayReservedDate>
                                                reservedDates) {
